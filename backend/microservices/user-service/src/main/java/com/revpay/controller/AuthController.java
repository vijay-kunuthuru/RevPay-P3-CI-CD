...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> verifyPin(@RequestParam Long userId,
            @Valid @RequestBody com.revpay.model.dto.VerifyPinRequest request) {
        authService.verifyTransactionPin(userId, request.getPin());
        return ResponseEntity.ok(ApiResponse.success(true, "PIN verified"));
    }
}